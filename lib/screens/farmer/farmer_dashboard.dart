...
class _FarmerDashboardState extends State<FarmerDashboard> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      _totalProducts = HiveService.countProductsByFarmer(farmerId);
      _weeklyProductsAdded = HiveService.countProductsByFarmerSince(farmerId, weekAgo);
      _totalOrders = HiveService.countOrdersForFarmer(farmerId);
      _weeklyOrdersReceived = HiveService.countOrdersForFarmerSince(farmerId, weekAgo);
      _totalSales = HiveService.sumSalesForFarmer(farmerId);
      _weeklySales = HiveService.sumSalesForFarmerSince(farmerId, weekAgo);

      final allOrders = HiveService.getOrdersByFarmer(farmerId);
