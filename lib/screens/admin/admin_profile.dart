...
class _AdminProfileState extends State<AdminProfile> {
  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      if (userId != null) {
        userMap = HiveService.getUserById(userId);
      }
      userMap ??= HiveService.getUserByEmail('admin@villagemarket.com');
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      await HiveService.upsertUser(updated);
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      try {
        final updated = { ...?_userData, 'avatar': file.path };
        await HiveService.upsertUser(updated);
      } catch (_) {}
    }
  }
